...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Find your perfect 55+ community in Las Vegas. Sun City Summerlin, Sun City Aliante, Del Webb Lake Las Vegas, Heritage at Stonebridge, Solera, Trilogy. Dr. Jan Duffy specializes in active adult living. Call (702) 996-3758.",
  path: "/55-plus-communities",
  keywords: ["55+ communities Las Vegas","active adult communities Las Vegas","Sun City Summerlin","Sun City Aliante","Del Webb Lake Las Vegas","Heritage at Stonebridge","Solera at Anthem","Trilogy Summerlin","retirement communities Nevada","55 plus homes Las Vegas"],
});
    ...
    <>
      ...
      <main>
        <IronMountainPageHero
          ...
          subtitle="Sun City, Del Webb, Heritage at Stonebridge and more—Dr. Duffy specializes in active adult living"
        >
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center bg-white/15 text-white border border-white/25 px-8 py-4 rounded-md font-bold text-lg hover:bg-white/25 transition-colors"
            >
              Explore Communities
