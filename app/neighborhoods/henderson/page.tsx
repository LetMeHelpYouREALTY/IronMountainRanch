...
export const metadata: Metadata = buildPageMetadata({
  ...
  description: "Find Henderson homes with Berkshire Hathaway HomeServices Nevada Properties. Dr. Jan Duffy specializes in Henderson's family-friendly communities. Median price $485K. Call (702) 996-3758.",
    ...
    <>
      ...
      <main>
        <IronMountainPageHero
          ...
          subtitle="Nevada's safest city. Find your Henderson home with Dr. Jan Duffy, your trusted Berkshire Hathaway HomeServices Henderson specialist."
        />
