      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            Ready to tour Iron Mountain Ranch?
          </h2>
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Search gated village homes in 89131 and 89143, or book a private showing with Dr. Jan
            Duffy.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <Button asChild size="lg" className="bg-white text-blue-600 hover:bg-blue-50">
              <Link href="/buy#imr-search" className="flex items-center gap-2">
            ...
            <Button
              ...
              className="border-white text-white hover:bg-white/10"
            >
              <Link href="tel:+17029963758" className="flex items-center gap-2">
